...
var CoinbaseWalletConnector = class extends WagmiConnector {
  ...
  async getProvider() {
    var _a;
    if (!_classPrivateFieldGet(this, _provider)) {
      let CoinbaseWalletSDK = (await import("./dist-2DHWZAWR.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-E7YV2ZFJ.js.map
