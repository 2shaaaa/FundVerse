...
function useRainbowWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./formFields-aa9e8c3f.browser.esm-I2K7IDCC.js").then(function(n) {
      return n.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-58773886.browser.esm-U47YOHZY.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-41e93ea8.browser.esm-6QRNOHKV.js");
...
function usePaperWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-968c4544.browser.esm-D2CTDQDF.js").then(function(n) {
      return n.a;
    });
...
function useWalletConnectV1() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-0f88eb7f.browser.esm-VM5M7RJ5.js");
...
//# sourceMappingURL=chunk-ID3XPZQ6.js.map
