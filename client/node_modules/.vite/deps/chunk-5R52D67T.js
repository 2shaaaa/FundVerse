...
function useRainbowWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./formFields-aa9e8c3f.browser.esm-MUM6F6JH.js").then(function(n) {
      return n.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-58773886.browser.esm-YNEV6FEC.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-41e93ea8.browser.esm-5YRG4AJN.js");
...
function usePaperWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-968c4544.browser.esm-SMPDKY4F.js").then(function(n) {
      return n.a;
    });
...
function useWalletConnectV1() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-0f88eb7f.browser.esm-RACLDP6A.js");
...
//# sourceMappingURL=chunk-5R52D67T.js.map
